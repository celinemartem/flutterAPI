...
import 'package:vsc_apitrial/services/notes_service.dart';
import 'package:vsc_apitrial/views/note_delete.dart';
import 'package:vsc_apitrial/views/note_modify.dart';
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            Navigator.of(context)
                ...
                .then((_) {
              _fetchNotes(); //refresh list of notes
            });
          },
